...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="{{route('casedetail.index')}}"><i class="fa fa-info-circle"></i> Case Details</a></li>
      <li><a href="{{route('caseschedule.index')}}"><i class="fa fa-exchange"></i> Case Schedule</a></li>
      <li><a href="{{route('clerk.index')}}"><i class="fa fa-users"></i> Court Clerks</a></li>
      <li><a href="{{route('judge.index')}}"><i class="fa fa-gavel"></i> Judge</a></li>
