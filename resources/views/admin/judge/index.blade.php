        ...
        <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default">
                    <span class="fa fa-plus"></span> Add Judge
                </button>
                {{-- @endif --}}
                <br>
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-responsive table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- @if((Auth::user()->id==$judge->id||Auth::user()->role->id==2||Auth::user()->role->id==1)) --}}
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$judge->email}}</td>
                                            <td>{{$judge->phone}}</td>
                                            <td>{{$judge->created_at->diffForHumans()}}</td>
                                            

                                            <td style="text-align: center">


                                                <a href="{{ route('judge.edit',$judge->id) }}"><span
                        ...
                        <form action="{{ route('judge.store') }}" method="post">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><span class="fa fa-user"></span> Add Judge
                                    </h4>
                                </div>
